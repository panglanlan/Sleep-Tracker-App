...
public class LogActivity extends Activity {
	...
	*/
	...
	if (cursor != null) {
	    ...
	    comments = cursor.getString(cursor.getColumnIndex(SleepLogHelper.COMMENTS));
	...
	*/		
    ...
    private void setTimeDisplay(String totalSleep, String fAsleepTime, String fAwakeTime)
    {
	TextView totalSleepText = (TextView) findViewById(R.id.total_sleep);
	totalSleepText.setText(mTypeOfSleep + ": " + totalSleep);
	TextView asleepText = (TextView) findViewById(R.id.asleep_time);
